...
('coreflexive equalizers', 'coquotients of cocongruences'),
('reflexive coequalizers', 'coequalizers'),
('reflexive coequalizers', 'sifted colimits'),
('reflexive coequalizers', 'quotients of congruences'),
('quotients of congruences', 'coequalizers'),
('quotients of congruences', 'reflexive coequalizers'),
('coquotients of cocongruences', 'equalizers'),
('coquotients of cocongruences', 'coreflexive equalizers'),
('direct', 'one-way'),
('direct', 'skeletal'),
('inverse', 'one-way'),
('inverse', 'skeletal'),
